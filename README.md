...
curl -L -o GeFeSLE-systray-setup.exe "https://github.com/tezoatlipoca/GeFeSLE-systray/releases/download/v0.1.2/GeFeSLE-systray_0.1.2_win-x64.setup.exe"
...
```bash
# Using curl
curl -L -o GeFeSLE-systray-win64.zip "https://github.com/tezoatlipoca/GeFeSLE-systray/releases/download/v0.1.2/GeFeSLE-systray_0.1.2_win-x64.zip"
...
curl -L -o gefesle-systray.deb "https://github.com/tezoatlipoca/GeFeSLE-systray/releases/download/v0.1.2/GeFeSLE-systray_0.1.2_linux_x64.deb"
...
curl -L -o gefesle-systray.rpm "https://github.com/tezoatlipoca/GeFeSLE-systray/releases/download/v0.1.2/GeFeSLE-systray_0.1.2_linux_x64.rpm"
...
curl -L -o gefesle-systray-linux.tar.gz "https://github.com/tezoatlipoca/GeFeSLE-systray/releases/download/v0.1.2/GeFeSLE-systray_0.1.2_linux_x64.tar.gz"
